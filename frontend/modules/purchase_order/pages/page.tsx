...
import {useCreatePurchaseMutation} from "../slice/purchaseapiSlice";
...
const [formData, setFormData] = useState<PurchaseState>({
  supplier_name: "",
  company_name: "",
  supplier_contact: "",
  supplier_address: "",
...
const [createPurchase]=useCreatePurchaseMutation();
  const { supplier_name, company_name, supplier_contact, supplier_address, gstin, status, items } = formData;
...
setFormData((prev) => ({
  ...
  if (!supplier_name.trim() || !company_name.trim() || !supplier_contact.trim()) {
