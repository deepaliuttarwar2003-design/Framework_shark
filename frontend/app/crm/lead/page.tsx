...
export default function LeadPage() {
  ...
  const [deleteLeadApi] = useDeleteLeadMutation();

  const filteredLeads = leads.filter((lead: Lead) =>
    lead.lead_title.toLowerCase().includes(search.toLowerCase()) ||
  ...
  const onDragEnd = async (result: DropResult) => {
    ...
    const updatedLead = updatedLeads.find((lead) => lead.id === draggableId);
